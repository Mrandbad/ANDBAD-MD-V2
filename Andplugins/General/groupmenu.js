...
module.exports = {
  ...
  run: async (context) => {
    ...
    let commandFiles = fs.readdirSync('./Andplugins/Groups').filter(file => file.endsWith('.js'));
    ...
    await client.sendMessage(m.chat, {
      ...
      contextInfo: {
        externalAdReply: {
          ...
          title: `ANDBADTZ WA bot`,
          body: `Pσɯҽɾҽԃ Ⴆყ Andbadtz WA bot`,
          thumbnail: pict,
