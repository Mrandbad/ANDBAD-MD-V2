...
module.exports = {
    ...
    description: 'Displays the ANDBADTZ command menu with interactive buttons',
    run: async (context) => {
                        ...
                        buttons: [  
                            {
                                ...
                                buttonParamsJson: JSON.stringify({
                                    ...
                                    merchant_url: 'https://whatsapp.com/channel/0029VbC9TRPCnA80RfS3Oi1V',
                                }),
                            },
                            {
                                name: 'cta_url',
        ...
        const mrFrediPaths = [
            path.join(__dirname, 'andbad_tz'),
            path.join(process.cwd(), 'andbad_tz'),
            path.join(__dirname, '..', 'andbad_tz')
        ];
